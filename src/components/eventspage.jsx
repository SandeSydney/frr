        ...
        <Container>
          ...
          <div className="event_row">
            <div className="events_cols">
              ...
              <h3>Weddings</h3>
              <p>
                Fred's Ranch & Resort is the perfect spot to tie the knot. Come
                gather with your friends and relatives to celebrate your big
                day.
              </p>
              <p>
                We offer the perfect wedding spot that is within your budget and
                the comfort zone of every invited guest. Fred's Ranch & Resort
                comes through your day with linens, to flatware, banquet chairs,
                and more.
              </p>
            </div>
            <div className="events_cols">
          ...
          <div className="event_row">
            <div className="events_cols">
              ...
              <p>
                ...
                your birthday's and special days. We are the best when it comes
                to appreciating your special day with song and dance.
              </p>
              <p>
                Do you want to have a surprise celebration for your loved ones?
                We got you covered. We are just a call away from making the most
                cherishing memories.
              </p>
            </div>
            <div className="events_cols">
              ...
              <p>
                We take conferencing very seriously. Fred's Ranch & Resort has a
                conferencing venue that grants a spacious avenue for delegates
                to happily mingle and enthusiastically chat.
              </p>
              <p>

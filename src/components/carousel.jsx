    ...
    <Carousel fade>
      ...
      <Carousel.Item className="carousel_item">
        ...
        <Carousel.Caption className="school_caption">
          <p className="text-xl md:text-5xl font-bold text-[#114344] school_stroke">SCHOOL OF HOSPITALITY</p>
          <p className='text-sm md:text-2xl font-bold italic font-[Dancing-script] text-[#6d401f]'>A Center of Excellence in Tourism & Hospitality</p>
